...
cmd_helper_others = {
	...
	["bob"] = {
		reason = " [ID] [Дни] - Забанить за обход (-7)",
	},
	["sob"] = {
		reason = " [ID] [Дни] - Забанить за обход (7+)",
	},
...
CMDMUTE = 
"/fs [ID] - flood/spam \n/ofs [NICK] - flood/spam (оффлайн) \n/fsf [ID] - flood/spam (forum) \n/ofsf [NICK] - flood/spam (forum) (оффлайн) \n/fsr [ID] - flood/spam ранее \n \n" ..
...
"/bob [ID] [Дни] - забанить за обход (-7) \n/sob [ID] [Дни] - забанить за обход (7+) \n/obob [NICK] [Дни] - забанить за обход (оффлайн) \n" ..
